...
function GlassDialogHeader({ icon = "mdi:information-outline", title, subtitle, accent = "#1e90ff", onClose, closeAutoFocus = false }) {
  const { Box: Box6, Typography: Typography6, IconButton: IconButton3, Stack: Stack5 } = getMaterialUI();
  const { Icon: Icon4 } = UI;
  ...
  return /* @__PURE__ */ jsxs2(Box6, { className: "isa-glass-dialog__header", sx: { position: "relative", flexShrink: 0 }, children: [
    /* @__PURE__ */ jsx3(Box6, { sx: bandSx, children: /* @__PURE__ */ jsxs2(Stack5, { direction: "row", spacing: 1.25, alignItems: "center", sx: { pr: onClose ? 4 : 0 }, children: [
      /* @__PURE__ */ jsx3(Box6, { sx: iconSx, children: /* @__PURE__ */ jsx3(Icon4, { icon, size: 24 }) }),
      /* @__PURE__ */ jsxs2(Box6, { sx: { flex: 1, minWidth: 0 }, children: [
        /* @__PURE__ */ jsx3(Typography6, { variant: "h5", component: "h2", sx: titleSx, children: title }),
        subtitle ? /* @__PURE__ */ jsx3(Typography6, { variant: "caption", color: "text.secondary", display: "block", sx: { mt: 0.35, lineHeight: 1.4 }, children: subtitle }) : null
      ] })
    ] }) }),
